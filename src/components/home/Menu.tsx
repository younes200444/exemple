  ...
  return (
    ...
    >
        ...
        <ScrollReveal direction="punchy" className="mb-14 md:mb-20">
          <div className="glow-wine relative overflow-hidden border border-wine/40 bg-gradient-to-br from-cream via-[#fff0e4] to-[#f8dcc8] px-5 py-8 sm:px-10 sm:py-10">
            <div className="pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-ember/20 blur-2xl" />
            <p className="mb-6 inline-flex items-center gap-2 rounded-none border border-ember/50 bg-ember/10 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.3em] text-ember">
            ...
            <ul>
              {chefPicks.map((item, i) => (
                <li
                  key={item.id}
                  className={cn(
                    "flex items-baseline gap-3 py-4 transition-colors hover:bg-wine-soft/40",
                ...
                >
                  ...
                  <motion.span
                    ...
                    whileHover={{ scale: 1.18, rotate: -4, color: "#a02830" }}
